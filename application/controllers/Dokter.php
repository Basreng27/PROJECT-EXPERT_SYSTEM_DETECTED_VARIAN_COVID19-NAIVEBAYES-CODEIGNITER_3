...
class Dokter extends CI_Controller
{
	...
	public function riwayat()
	{
		...
		$data['riwayat'] = $this->M_admin->get_all_riwayat()->result();
	...
	public function delete_virus()
	{
		...
		$v = $this->M_admin->get_v($new_kode_virus)->row();

		$data_riwayat = array(
			'kode_virus' => $v->kode_virus,
			'nama_virus' => $v->nama_virus,
			'solusi' => $v->solusi
		);

		$this->M_admin->insert_riwayat($data_riwayat);
