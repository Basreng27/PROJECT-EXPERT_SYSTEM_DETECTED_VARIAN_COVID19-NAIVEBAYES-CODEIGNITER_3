...
class M_admin extends CI_Model
{
	...
	{
		$this->db->set('kode_virus', $data_riwayat['kode_virus']);
		$this->db->set('nama_virus', $data_riwayat['nama_virus']);
		$this->db->set('solusi', $data_riwayat['solusi']);
