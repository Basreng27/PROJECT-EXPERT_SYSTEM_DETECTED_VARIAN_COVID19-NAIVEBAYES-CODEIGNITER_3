        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="<?php echo base_url() ?>dashboard_admin" aria-expanded="false"><i class="icon icon-home"></i><span class="nav-text">Dashboard Admin</span></a></li>
                    ...
                    <!-- <li><a href="<?php echo base_url() ?>aturan_pakar" aria-expanded="false"><i class="icon icon-world-2"></i><span class="nav-text">Aturan Pakar</span></a></li> -->
